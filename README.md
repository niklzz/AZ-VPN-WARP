...
Поковыряв WARP и выяснив, что если выходная нода WARP является не DME/LED, то мы получаем следующие плюсы при деплое AZ VPN сервера внутри РФ:
...
- Интегрирован "сканер" WARP серверов, который показывает доступные выходные ноды (HEL,ARN,DME) с вашего сервера и дает выбирать ноду с лучшим пингом
