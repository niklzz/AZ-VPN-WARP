...
PARSE_LINK=https://raw.githubusercontent.com/$V2_REPO/main/setup/root/antizapret/parse.sh
PARSE_PATH=parse.sh

DOALL_LINK=https://raw.githubusercontent.com/$V2_REPO/main/setup/root/antizapret/doall.sh
DOALL_PATH=doall.sh
